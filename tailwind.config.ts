    ...
    extend: {
      ...
      keyframes: {
        ...
        "chip-slide": {
          ...
          "100%": { transform: "translate(var(--chip-move-x), var(--chip-move-y))", opacity: "0.5" },
        },
        "scale-in": {
      ...
      animation: {
        ...
        "chip-slide": "chip-slide 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards",
      },
    },
  },
