/**
 * Wave 5D — Holm anchored slot.
 *
 * Pure consumer of a single anchored placement from
 * HolmGameplayGeometryProvider. Mirrors Yahtzee/Dice/Gin slot pattern,
 * installs the standard DOM-bounds contract + center-drift assertion.
 */
...
export const HolmAnchoredSlot = forwardRef<HTMLDivElement, HolmAnchoredSlotProps>(
  function HolmAnchoredSlot(
    { artifactId, zIndex = 110, innerStyle, children },
    forwardedRef,
  ) {
...
export default HolmAnchoredSlot;
