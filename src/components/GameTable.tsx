    ...
    <div className="relative p-0.5 sm:p-1 md:p-2 lg:p-4 xl:p-8">
      ...
      <div className="relative bg-gradient-to-br from-poker-felt to-poker-felt-dark rounded-[50%] aspect-[2/1] w-full max-w-5xl mx-auto p-1 sm:p-2 md:p-4 lg:p-8 xl:p-12 shadow-2xl border-2 sm:border-3 md:border-4 lg:border-6 xl:border-8 border-amber-900 scale-90 sm:scale-95 md:scale-100">
        ...
        <div className="relative h-full">
          ...
          {lastRoundResult && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-30 w-[90%] max-w-md pointer-events-none">
          ...
          {showPotAndTimer && (
            <>
              {/* Pot and Timer Container - centered for Holm, left side for 3-5-7 */}
              <div className={`absolute top-1/2 ${gameType === 'holm-game' ? 'left-1/2' : 'left-[15%]'} transform -translate-x-1/2 -translate-y-1/2 z-20`}>
