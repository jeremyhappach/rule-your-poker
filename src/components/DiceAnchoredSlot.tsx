/**
 * Wave 5D — Dice anchored slot (generic; Horses + SCC).
 *
 * Mirrors YahtzeeAnchoredSlot / GinAnchoredSlot. Pure consumer of a
 * single anchored placement from DiceGameplayGeometryProvider.
...
export function DiceAnchoredSlot({
  artifactId,
  zIndex = 110,
  innerStyle,
  children,
}: DiceAnchoredSlotProps) {
...
export default DiceAnchoredSlot;
