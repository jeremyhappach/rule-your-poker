/**
 * Wave 5D — Yahtzee anchored slot (generic).
 *
 * Mirrors GinAnchoredSlot. Pure consumer of a single anchored
 * placement from YahtzeeGameplayGeometryProvider. Renders children
...
export function YahtzeeAnchoredSlot({
  artifactId,
  zIndex = 110,
  innerStyle,
  children,
}: YahtzeeAnchoredSlotProps) {
...
export default YahtzeeAnchoredSlot;
