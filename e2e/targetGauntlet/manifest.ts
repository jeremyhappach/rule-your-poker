...
export const TARGET_GAUNTLET_MANIFEST: readonly TargetGauntletScenario[] = [
  ...
  { id:'357-terminal-postgame-handoff', gameType:'3-5-7', program:'357-instant-sweep', fixtureProfile:'357:terminal:instant_sweep', config:{legsToWin:1,legValue:1,rolloverAmount:1}, coverage:['terminal-award','authoritative-postgame','next-dealer-setup','connected-peer-no-refresh','exact-config-retention'] },
