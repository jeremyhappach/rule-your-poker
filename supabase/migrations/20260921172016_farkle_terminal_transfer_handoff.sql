-- Additive Farkle terminal COMMIT handoff. Production scoring remains unapproved.
...
BEGIN
 ...
 INSERT INTO private.farkle_terminal_transfers_v2(transaction_id,game_id,dealer_game_id,round_id,result_id,action_sequence,opening_balances,closing_balances)
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- Only the exact deferred Farkle terminal transfer may acquire this claim.
