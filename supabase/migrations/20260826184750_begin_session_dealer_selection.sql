...
END;
$function$;
REVOKE ALL ON FUNCTION public.begin_session_dealer_selection(uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.begin_session_dealer_selection(uuid) TO authenticated, service_role;
