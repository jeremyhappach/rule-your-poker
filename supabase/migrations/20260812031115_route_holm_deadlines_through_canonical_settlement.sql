...
BEGIN
  ...
  FOR UPDATE;
  IF NOT FOUND OR v_player.status <> 'active' OR coalesce(v_player.sitting_out, false) THEN
  ...
  SELECT public.holm_submit_decision(p_game_id, p_player_id, p_decision) INTO v_result;
