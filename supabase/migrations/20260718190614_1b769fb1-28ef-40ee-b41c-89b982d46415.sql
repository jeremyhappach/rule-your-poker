...
-- Drop the previous jsonb-parameter variant.
DROP FUNCTION IF EXISTS public.holm_settle_hand(
...
GRANT EXECUTE ON FUNCTION public.holm_settle_hand(
  uuid, uuid, integer, public.holm_event_kind, integer, boolean, text, jsonb, text, uuid, text, boolean, integer
